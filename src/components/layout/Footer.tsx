      ...
      case "instagram":
        return (
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            <path fillRule="evenodd" d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.987 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.23 16.72c-2.086 0-3.78-1.693-3.78-3.78s1.693-3.78 3.78-3.78 3.78 1.693 3.78 3.78-1.693 3.78-3.78 3.78zm7.554 0c-2.086 0-3.78-1.693-3.78-3.78s1.693-3.78 3.78-3.78 3.78 1.693 3.78 3.78-1.693 3.78-3.78 3.78z" clipRule="evenodd" />
          </svg>
        );
      case "facebook":
        return (
